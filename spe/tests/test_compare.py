...
def test_compare(n=100):
    ...
    (true_mse_tst,
     kfcv_mse_tst, 
     spcv_mse_tst,
     gmcp_mse_tst) = mse_sim.compare(LinearRegression(fit_intercept=False),
    ...
    (true_mse_tst,
     kfcv_mse_tst, 
     spcv_mse_tst,
     gmcp_mse_tst) = mse_sim.compare(RelaxedLasso(lambd=0.1),
    ...
    (true_mse_tst,
     kfcv_mse_tst, 
     spcv_mse_tst,
     gmcp_mse_tst) = mse_sim.compare(BaggedRelaxedLasso(base_estimator=RelaxedLasso(lambd=0.5),
                                                        n_estimators=5),
    ...
    (true_mse_tst,
     kfcv_mse_tst, 
     spcv_mse_tst,
     gmcp_mse_tst) = mse_sim.compare(BlurredForest(n_estimators=5),
